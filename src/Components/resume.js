...
//ICONE MATERIAL
import { resumeEducation, resumeExperience, resumeSkills } from "./costants/constants";

function Resume() {
    return (
        <>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ ease: "easeIn", duration: 1 }} viewport={{ once: true }}>
                <Typography textAlign='center' variant="h2" color='white' class='gradient-text-resume'>Resume</Typography>
            </motion.div>
            <Grid container spacing={5}>
                <Grid item xs={4} >
                    <Grid container>
                        ...
                        <Grid item xs={6}>
                            <Typography variant="h8" color='white'> <span class='gradient-text-resumeText'>Education</span></Typography>
                        </Grid>
                        <Grid item xs={11}>
                ...
                <Grid item xs={4}>
                    <Grid container>
                        ...
                        <Grid item xs={6}>
                            <Typography variant="h8" color='white'><span class='gradient-text-resumeText'>Experience</span></Typography>
                        </Grid>
                        <Grid item xs={12}>
